    ...
    <div className="h-[40rem] w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm md:text-base lg:text-xl  text-center relative z-10">
          If you want to get regular email update regarding various islamic
          lecture video, blog, halaka schedule, scholar information and other
          islamic information then subscribe to our newletter option.
        </p>
        <input
          type="text"
