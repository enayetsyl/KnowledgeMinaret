        ...
        <div key={i} className={cn(card.className, "")}>
          <motion.div
            ...
            className={cn(
              ...
              selected?.id === card.id
                ? "rounded-lg cursor-pointer absolute top-[110vh] md:top-[140vh] lg:top-[165vh]  left-0 right-0 bottom-0 h-1/2 w-full md:w-1/2 m-auto z-50 flex justify-center items-center flex-wrap flex-col"
